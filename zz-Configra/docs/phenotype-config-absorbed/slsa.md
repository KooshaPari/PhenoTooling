...
> This document is preserved verbatim as part of the L5-110 / T10.1 absorb
> wave. The release pipeline referenced (`.github/workflows/release-attestation.yml`)
> now lives at `KooshaPari/Configra/.github/workflows/release-attestation.yml`
> (not yet present — to be added in a follow-up PR).
