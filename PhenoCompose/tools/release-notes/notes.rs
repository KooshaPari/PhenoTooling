...
fn main() {
    ...
    for line in out.lines() {
        if line.starts_with("feat:") || line.starts_with("feat(") {
            feat += 1;
        } else if line.starts_with("fix:") || line.starts_with("fix(") {
            fix += 1;
        } else if line.starts_with("chore:") || line.starts_with("chore(") {
            chore += 1;
        } else {
            other += 1;
        }
